package lander {
	...
	public class LevelState {
		...
		private var p_wonGame:Boolean;
		private var p_messageStr:String; 
		private var p_speedBoxStr:String; 
		
		
		public function LevelState(landerPosition:vector2d, landerVelocity:vector2d, landerRotation:Number, gameOver:Boolean, 
									wonGame:Boolean,
									msg:String, 
									speedBoxStr:String){
		...
		public function get wonGame():Boolean {
			return p_wonGame;
		}
	}
}
